...
(function () {
  ...
  const other = pairedPages.has(baseStem)
    ? (EN ? baseStem + '.html' : baseStem + '-en.html')
    : '';
  ...
  if (pairedPages.has(baseStem)) {
    ...
    if (!document.querySelector('link[rel="canonical"]')) {
      ...
      canonical.href = origin + '/' + (EN ? baseStem + '-en.html' : (baseStem === 'index' ? '' : baseStem + '.html'));
      document.head.appendChild(canonical);
    }
    [['tr', baseStem === 'index' ? '' : baseStem + '.html'], ['en', baseStem + '-en.html']].forEach(function (pair) {
